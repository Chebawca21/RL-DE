...
class RL_HPSDE_N_WALKS(RL_HPSDE):
    def __init__(self, dimension, func, max_population_scalar, min_population_size, max_fes, memory_size, num_walks=5, num_steps=200, step_size=10, p=0.1, archive_size=None):
        self.D = dimension
        self.func = func
